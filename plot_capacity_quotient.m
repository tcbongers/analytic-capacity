...
function max_error = plot_capacity_quotient(centers_left, centers_right, max_radius, num_rings, num_scales)

centers = [centers_left, centers_right]

ups_union = zeros(1, num_scales);
lows_union = zeros(1, num_scales);

ups_left = zeros(1, num_scales);
lows_left = zeros(1, num_scales);

ups_right = zeros(1, num_scales);
lows_right = zeros(1, num_scales);


for k = 1:num_scales
	k
	radius = max_radius * k / num_scales;
